...
namespace ThermostatEventsApp
{
  ...
  public class Thermostat : IThermostat
  {
    ...
    public void WireUpEventsToEventHandlers()
    {
      _heatSensor.TemperatureReachesWarningLevelEventHandler += HeatSensor_TemperatureReachesWarningLevelEventHandler;
      _heatSensor.TemperatureFallsBelowLevelEventHandler += HeatSensor_TemperatureFallsBelowLevelEventHandler;
    ...
    private void HeatSensor_TemperatureFallsBelowLevelEventHandler(object? sender, TemperatureEventArgs e)
    {
  ...
  public class HeatSensor : IHeatSensor
  {
    ...
    event EventHandler<TemperatureEventArgs> IHeatSensor.TemperatureFallsBelowLevelEventHandler
    {
      add
      {
  ...
  public interface IHeatSensor
  {
    ...
    event EventHandler<TemperatureEventArgs> TemperatureFallsBelowLevelEventHandler;
